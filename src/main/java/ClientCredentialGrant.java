...
class ClientCredentialGrant {
    ...
    public static void main(String args[]) throws Exception{
        ...
        try {
            ...
            String message = callAPI(result.accessToken());

            System.out.println("Token is " + message);
    ...
    private static String callAPI(String accessToken) throws IOException {
        URL url = new URL("http://localhost:26693/WeatherForecast");
